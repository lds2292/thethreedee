...
| 상태 | 기능 |
|---|---|
| ✅ | Directive Context Validator (Lint 탭) |
| ✅ | Location Priority Analyzer + Match Tester (Locations 탭) |
| ✅ | SSL Security Scorer (Summary 탭) |
| ✅ | Upstream Configuration Linter (Lint 탭) |
| ✅ | Formatted 탭 Syntax Highlighting |
| ✅ | Indent 선택 (2sp / 4sp / Tab) |
| ✅ | 샘플 conf 제공 (기본 웹서버 / Reverse Proxy / SSL) |
| ✅ | Locations 탭 expand / collapse |
| ✅ | 전체 URL 테스트 지원 (https://... → pathname 추출) |
| ⬜ | Directive Inline Reference |
| ⬜ | Block Inheritance Visualizer |
| ⬜ | Server Name Matcher |
| ⬜ | Known Pattern Library |
| ⬜ | Directive Completeness Checker |
| ⬜ | 라인 번호 + 에러 줄 표시 |
| ⬜ | Diff 뷰 |
| ⬜ | URL 공유 (`?config=base64`) |
